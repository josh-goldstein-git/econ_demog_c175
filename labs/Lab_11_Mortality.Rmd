---
title: "Lab_13_mortality: Education and Old-Age Mortality"
...
>    groups? (Here we will compare Blacks and Whites.)
...
#dt <- data.table::fread("/data175/censoc_bfdw.csv")
#source("/data175/labels_and_variables_for_censoc.R")

dt <- system('chmod +777 ~/econ_demog_c175_2023/data/lab_11_data_download.sh && ~/econ_demog_c175_2023/data/lab_11_data_download.sh')
