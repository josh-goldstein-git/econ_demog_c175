...
> https://berkeley-demog.shinyapps.io/new-malthus/, we can simulate
...
If you want to do a mini-project later in the semester 
(more details on mini-projects to follow), here are some possibilities for 
